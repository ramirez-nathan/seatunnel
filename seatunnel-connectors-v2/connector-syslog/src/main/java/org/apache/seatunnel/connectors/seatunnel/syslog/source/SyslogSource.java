...
public class SyslogSource extends AbstractSingleSplitSource<SeaTunnelRow> {
    private final SyslogConfig parameter;
    private final CatalogTable catalogTable;
    private JobContext jobContext;

    public SyslogSource(ReadonlyConfig pluginConfig) {
        this.parameter = new SyslogConfig(pluginConfig);
        SeaTunnelRowType seaTunnelRowType =
                new SeaTunnelRowType(
                        new String[] {"value"}, new SeaTunnelDataType<?>[] {BasicType.STRING_TYPE});
        this.catalogTable =
                CatalogTableUtil.getCatalogTable(SyslogSourceOptions.identifier, seaTunnelRowType);
    }
    ...
    public AbstractSingleSplitReader<SeaTunnelRow> createReader(
        ...
        return new SyslogSourceReader(this.parameter, readerContext);
    }
}
